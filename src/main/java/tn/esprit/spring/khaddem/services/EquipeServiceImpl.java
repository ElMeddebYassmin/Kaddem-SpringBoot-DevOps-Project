...
public class EquipeServiceImpl implements IEquipeService {
    ...
    @Override
    public Equipe updateEquipe(Equipe e, Integer id) {
        ...
        if (optionalEquipe.isPresent()) {
            ...
            Equipe finalE = equipeRepository.save(equipe);
            return finalE;
        } else {
            throw new NoSuchElementException("Equipe not found for id: " + id);
        }
    }
    ...
    public Equipe retrieveEquipe(Integer idEquipe) {
        ...
        if (optionalEquipe.isPresent()) {
            ...
            throw new NoSuchElementException("Equipe not found for id: " + idEquipe);
        }
    }
                ...
                if ((equipe.getNiveau().equals(Niveau.JUNIOR)) || (equipe.getNiveau().equals(Niveau.SENIOR))) {
                    ...
                    for (Etudiant etudiant : etudiants) {
                        ...
                        for (Contrat contrat : contrats) {
                            ...
                            if ((contrat.getArchived() == null || !contrat.getArchived()) && (difference_In_Years > 1)) {
